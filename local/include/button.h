...
BUTTON *createButton(SDL_Renderer *renderer, char *link, BUTTON * buttonList, int w, int h, int x, int y, functions function, menu menu, int srcsizew, int srcsizeh, int numberOfSprite); //Créé un nouveau bouton
