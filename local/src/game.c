        ...
        do
        {
            if (game->loop % FIREBALL_MOVELOOP == 0 && game->loop != 0 && game->score > 0)
            {
                if (fireball.first != NULL)
                {
                    ...
                    {
                        SL_playSong("fire", 20, 0);
                    }
                    else if (output == 3)
                    {
                        SL_playSong("fire_2", 20, 0);
                    }
                    else if (output == 4)
                    {
                        SL_playSong("fire_3", 20, 0);
                    }
                }
            }
            if (temp != NULL)
