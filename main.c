...
int main()
{
    ...
    coin->sprite = newSprite(renderer, "texture/coin.png", 6, 84, SPRITE_SIZE);
    ...
    TEXTURE map = newTexture(renderer, "texture/map1.png");
    TEXTURE hole = newTexture(renderer, "texture/hole.png");
